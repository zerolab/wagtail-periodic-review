...
or, you can run them for a specific environment `tox -e python3.14-django6.0-wagtail7.4` or specific test
`tox -e python3.14-django6.0-wagtail7.4 -- tests.test_file.TestClass.test_method`
